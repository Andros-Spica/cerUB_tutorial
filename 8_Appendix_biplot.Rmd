...
As an example, consider the outcome of [protocol 1](3_prot1.html). In this case, robust PCA generated a good 2D projection (around 78% of variance) where CaO and MgO are the major contributors.
...
For example, [protocol 2](4_prot2.html) gave us a much worse 2D projection (55.7%) where fifteen variables are well represented.
