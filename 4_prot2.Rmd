...
The details on how to create biplots is already explained in [protocol 1](3_prot1.html). Concerning protocol 2, we can compare the results of version *2a* (RRD, PCoA) and *2b* (NI, NMDS).
