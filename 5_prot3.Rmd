...
The details on how to create biplots is already explained in [protocol 1](#biplot). Unlike protocol 2, protocol 3 only generates one kind of projection (RRD, PCoA).
