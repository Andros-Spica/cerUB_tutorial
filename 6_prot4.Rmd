...
The details on how to create biplots is already explained in [protocol 1](3_prot1.html). As protocol 3, protocol 4 only generates one kind of projection (RRD, PCoA).
